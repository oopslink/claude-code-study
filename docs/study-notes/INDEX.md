...
- [Task 1：启动流程与运行模式](phase-a/task-01-startup.md)
  — 并行启动优化、Feature Flags（COORDINATOR_MODE / KAIROS）、8 种运行模式、setup.ts 全局状态

- [Task 2：核心数据结构](phase-a/task-02-data-structures.md)
  — Message 类型 Union、PermissionMode、Tool 接口（~70 字段）、ToolUseContext、权限决策四元组

- [Task 3：六大子系统速览与边界图](phase-a/task-03-system-overview.md)
...
- [10 个可复用模式卡片索引](patterns/README.md)
